...
<html lang="en">
    <head>
    	...
    	<link rel="icon" href="https://cdn.treehouseinternetgroup.com/cms_images/7/bs-favicon.ico">
    ...
    <link rel="stylesheet" href="https://cdn.treehouseinternetgroup.com/cms_images/7/core_template.css" />
    ...
    <?php if ($thePage == "index") { ?>
        <link rel="preload" fetchpriority="high" href="https://cdn.treehouseinternetgroup.com/cms_images/7/LJ-CBS-Logo_new-Fonts-and-Tagline.png" as="image">
        <link rel="preload" fetchpriority="high" href="https://cdn.treehouseinternetgroup.com/cdn-cgi/image/width=600,quality=85,format=auto/cms_images/7/mm-video-poster-compressed.jpg" as="image" media="(max-width: 640px)">
        <link rel="preload" fetchpriority="high" href="https://cdn.treehouseinternetgroup.com/cdn-cgi/image/quality=85,format=auto/cms_images/7/mm-video-poster-compressed.jpg" as="image" media="(min-width: 640.1px)">
    <?php } ?>
        ...
        <!-- Start header__style3 token content -->
            <div id="header--logo">
                <a href="/" title="[company]">
                    <img src="https://cdn.treehouseinternetgroup.com/cms_images/7/LJ_CTBS_4C_RGB.svg" alt="[company]">
                </a>
            </div>
...
<div id="siloBanner"> <img src=
                        <?php
                            ...
                            {
                                ?>
                                 "https://cdn.treehouseinternetgroup.com/cdn-cgi/image/format=auto/cms_images/7/silo-about-ctbs.jpg"
                            <?php
                            }
...
<!-- end #siloBanner -->
        ...
        <?php if ( ($thePage != "service-area") && ($isCityPage == 0) ) { ?>
            ...
            <div id="service-area-map" class="container">
                ...
                <div id="map-target">
                    <img src="https://cdn.treehouseinternetgroup.com/cms_images/7/CTBS_map-Mar25-sm.png">
                </div>
