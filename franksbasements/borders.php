<?php
// Template customized for Frank's Basement Systems
...
<html lang="en">
    <head>
    	...
    	<link rel="icon" href="https://cdn.treehouseinternetgroup.com/cms_images/169/favicon-frank.ico">
    ...
    <link rel="stylesheet" href="https://cdn.treehouseinternetgroup.com/cms_images/169/core_template.css" />
    ...
    <?php if ($thePage == "index") { ?>
        <link rel="preload" fetchpriority="high" href="https://cdn.treehouseinternetgroup.com/cms_images/169/franks-basement-systems-log-with-services_-_Copy.png" as="image">
        <link rel="preload" fetchpriority="high" href="https://cdn.treehouseinternetgroup.com/cdn-cgi/image/width=600,quality=85,format=auto/cms_images/169/FMP_DroneFootageBG450.jpg" as="image" media="(max-width: 640px)">
        <link rel="preload" fetchpriority="high" href="https://cdn.treehouseinternetgroup.com/cdn-cgi/image/quality=85,format=auto/cms_images/169/FMP_DroneFootageBG.jpg" as="image" media="(min-width: 640.1px)">
    <?php } ?>
        ...
        <!-- Start header__style3 token content -->
            <div id="header--logo">
                <a href="/" title="[company]">
                    <img src="https://cdn.treehouseinternetgroup.com/cms_images/169/Franks_BasementSystems_4C.svg" alt="[company]">
                </a>
            </div>
